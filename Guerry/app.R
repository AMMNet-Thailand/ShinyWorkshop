...
ui <- dashboardPage(
            ...
            box(
              ...
              accordion(
              	...
              	accordionItem(
              		...
              		status = "primary",
              		solidHeader = FALSE,
              		p("This app was created as part of a Shiny workshop held in August 2023"),
              		p("Last update: August 2023")
              	)
              )
            )
          ),
  ...
  footer = dashboardFooter(
  	left = span(
  		...
  		a("here.", href = "https://github.com/AMMNet-Thailand/ShinyWorkshop"),
